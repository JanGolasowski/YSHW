...
namespace Cipher.Web.DependencyResolution
{
    using StructureMap;
    ...
    public class DefaultRegistry : Registry {
        ...
        {
            For<ICipher>().Use<MorseCodeCipher>().LifecycleIs<SingletonLifecycle>();
            For<ICipher>().Use(new FakeCipher(CipherType.Caesar));
        }
